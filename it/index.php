                ...
                <div class="tool-grid">
                    <?php
                        $tools = [
                            ...
                            ['title' => 'Decodificatore dei Numeri Angelici', 'desc' => 'Scopri i messaggi dell\'universo nei numeri.', 'icon' => '<i class="fa-solid fa-wand-magic-sparkles"></i>', 'url' => '/more-tools/angel-number-decoder/'],
