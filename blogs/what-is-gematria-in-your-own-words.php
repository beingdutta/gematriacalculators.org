...
<head>
    ...
    <meta name="description" content="What is Gematria in your own words? This simple guide explains the ancient code, how to use a gematria calculator, and how to find meaning in the numbers.">
        ...
        <main>
            <nav aria-label="breadcrumb" class="breadcrumb-container">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Gematria In Your Own Words</li>
                </ol>
            </nav>
            ...
            <div class="article-content">
                <div class="article-body">
                    ...
                    <p>
                        The Bible explicitly instructs the reader to use a gematria calculator (or their mind) to solve a puzzle. Most historians agree this refers to the Emperor Nero (Neron Kesar), whose name sums to 666 in Hebrew. This proves that what does gematria mean historically is a method of hiding dangerous political truths in plain sight.
                    </p>
